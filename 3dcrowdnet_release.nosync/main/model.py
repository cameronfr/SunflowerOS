...
class Model(nn.Module):
    ...
    def get_coord(self, smpl_pose, smpl_shape, smpl_trans):
        ...
        # WARNING: if train, note that changed joint_cam and mesh_cam to no longer be root relative (must change back)
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        joint_proj, joint_cam, mesh_cam, mesh_cam_render = ("Disabled", "Disabled", "Disabled", "Disabled") # Remove for speed
